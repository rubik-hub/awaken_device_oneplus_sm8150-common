...
# Get extra aspects
$(call inherit-product, vendor/extras/product.mk)
...
PRODUCT_COPY_FILES += \
    ...
    packages/apps/GCamGO/permissions/lily_experience.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/sysconfig/lily_experience.xml
